...
```
YouTube (lives) → Transcricao → Analise IA (Claude) → Corte (FFmpeg) → Publicacao (YouTube API)
```
...
5. **Publica clips** no YouTube com titulo, descricao e tags
...
- **IA**: Anthropic Claude API (analise de topicos)
